...
lowCaseAnimalNames = zooAnimals.map(function(element){
...
lowPopulationAnimals = zooAnimals.filter(function(element){
...
let Total = zooAnimals.reduce(function(populationTotal, element){
  return element.population + populationTotal;
}, 0)
console.log(Total);
